...
var dashboard$1 = {
    ...
    data: function data() {
        return {
            // foreColor,backColor
            command: 'foreColor',
            colors: ["#000", "#fff", "#f44336", "#E91E63", "#9C27B0", "#5E35B1", "#283593", "#039BE5", "#00BCD4", "#00897B", "#4CAF50", "#8BC34A", "#CDDC39", "#FFEB3B", "#FFC107", "#F57C00", "#FF5722", "#4E342E", "#212121", "#607D8B", "#263238"]
        }
    },
    methods: {
...
var i18nEnUs = {
    ...
    info: 'info',
    color: 'Màu sắc',
    'please enter a url': 'Nhập địa chỉ URL',
    'create link': 'Tạo liên kết',
    bold: 'Đậm',
    italic: 'Nghiêng',
    underline: 'Gạch chân',
    'strike through': 'Gạch giữa',
    subscript: 'Chữ ở dưới',
    superscript: 'Chữ ở trên',
    heading: 'heading',
    'font name': 'font name',
    'font size': 'font size',
    'left justify': 'Căn trái',
    'center justify': 'Căn giũa',
    'right justify': 'Căn phải',
    'ordered list': 'Danh sách đánh số',
    'unordered list': 'Danh sách chấm',
    'fore color': 'Màu văn bản  ',
    'background color': 'Màu nền văn bản  ',
    'row count': 'Số cột',
    'column count': 'Số hàng',
    save: 'Hiển thị',
    upload: 'upload',
    progress: 'progress',
    unknown: 'unknown',
    ...
    'exceed size limit': 'Ảnh quá giới hạn!'
};
